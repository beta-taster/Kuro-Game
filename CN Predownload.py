...
def check_for_updates():
    ...
    url_1 = "https://prod-cn-alicdn-gamestarter.kurogame.com/launcher/game/G152/10003_Y8xXrXk65DqFHEDgApn3cpK5lfczpFx5/index.json"
  #  url_2 = "https://prod-cn-alicdn-gamestarter.kurogame.com/pcstarter/prod/game/G152/10003_Y8xXrXk65DqFHEDgApn3cpK5lfczpFx5/index.json"
    ...
    if response_1.status_code == 200:
        ...
        if data_1 != last_data_1:
            send_webhooks(data_1, url_1, "Wuthering Waves CN (LAUNCHER)", last_data_1)
            last_data_1 = data_1
    else:
